  ...
  return (
    <div className="w-full min-h-screen flex justify-center relative">
      ...
      <div className="flex flex-col items-center justify-center">
        <p className="mb-[110px] text-[26px] text-center cursor-default">
          모임부터 일정, 협업까지 한 번에.
          <br />
        ...
        <div className="z-10">
          ...
          <input
            ...
            value={'로그인'}
          />
          <div className="flex justify-center space-x-2 mb-[60px] text-[14px]">
          ...
          <div className="flex items-center gap-4 mb-[30px]">
            ...
            <span className="opacity-50">또는</span>
            <hr className="flex-grow border-t border-main/20" />
          </div>

          <div className="flex justify-center">
            <button className="w-[390px] h-[50px] border border-main/30 rounded-[10px] flex justify-center items-center">
              <Image
