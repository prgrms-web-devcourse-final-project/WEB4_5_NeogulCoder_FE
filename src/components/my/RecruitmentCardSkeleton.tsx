export default function RecruitmentCardSkeleton() {
  return (
    <>
      <div className='flex flex-col justify-center w-full px-[24px] py-[24px] max-[1024px]:border-t max-[1024px]:last:border-y lg:border-2 border-gray-100 lg:rounded-[10px]'>
        ...
        <div className='h-[40px] w-1/2 bg-gray-100 rounded-[10px] animate-pulse mb-[18px]'></div>
