  ...
  return (
    <div className="flex flex-col border border-gray-100 bg-white w-[360px] h-[600px] overflow-auto rounded-[10px] drop-shadow-xl p-5 gap-5">
      <div className="flex justify-between items-center">
        ...
        <X
          className="w-5 h-5 text-text1/40 hover:text-text1/60 cursor-pointer"
          onClick={onClose}
        />
      </div>
      ...
      <ul className="flex flex-col">
        {notifications.map((item) => (
          <li
            key={item.id}
            className="t4 text-text1 hover:bg-[#90CFF1]/10 p-3 rounded-[6px] transition flex items-center justify-between"
          >
