...
export default function StudyRoomExtendWrite({ closeFn }: { closeFn: () => void }) {
  return (
    <>
            ...
            <form>
              <div className='px-9 mb-12 flex flex-col gap-4 max-h-[calc(90vh-160px)] overflow-auto'>
                <div className=' shrink-0'>
                  <p className='t2 mb-3'>
                    스터디의 새로운 종료일자 <span className='tm5 text-red'>(필수)</span>
                  </p>
                  <div className='text-center'>
                    <label className='relative'>
                      <input type='date' className='w-[300px] date-custom input-type2 tm3 pr-9!' />
                      <CalendarDays
                        strokeWidth={1}
