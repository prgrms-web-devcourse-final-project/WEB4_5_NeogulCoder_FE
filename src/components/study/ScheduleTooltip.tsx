...
export default function ScheduleTooltip() {
  return (
    <div className="w-[433px] px-[42px] py-[43px] bg-white border border-border1 rounded-[10px]">
      <div className="tb2 text-[22px] text-text1">모임 일정 조율이란?</div>
      <div className="mt-5 t3 text-text1 ">
        모임 일정 조율은 스터디 모임의 일정을 원활하게 관리하기 위한 기능입니다.
      </div>
      <div className="flex flex-col gap-1 justify-center w-[335px] h-[128px] t4 text-text1 mt-[30px] px-[13px] py-[11px] border border-border1 rounded-[6px]">
